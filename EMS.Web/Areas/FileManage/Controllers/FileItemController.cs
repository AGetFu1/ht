...
namespace EMS.Web.Areas.FileManage.Controllers
{
    ...
    {
        private FileItemApp itemsApp = new FileItemApp();
        ...
        public ActionResult GetTreeSelectJson()
        {
            ...
            foreach (FileItemEntity item in data)
            {
        ...
        public ActionResult SubmitForm(FileItemEntity itemsEntity, UserLogOnEntity userLogOnEntity, string keyValue)
        {
